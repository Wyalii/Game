  ...
  return(
      <div className="h-3/4 w-2/4 bg-white rounded flex items-center flex-col gap-5 pt-3">
          ...
          <div className="flex flex-col w-full gap-8">
            ...
            <div className="w-full flex justify-center">
               <button onClick={SignUp} className="placeholder:text-xs sm:placeholder:text-sm sm: w-1/2 max-w-xs focus:outline-none h-10 text-center bg-purple-600 text-white placeholder-white rounded">Sign Up</button>
            </div>
          </div>
